...
class PretrainRunner(BaseTimeSeriesForecastingRunner):
    ...
    def forward(self, data: tuple, epoch:int = None, iter_num: int = None, train:bool = True, **kwargs) -> tuple:
        ...
        # feed forward
        prediction, label_full = self.model(history_data=history_data, future_data=None, batch_seen=iter_num, epoch=epoch)

        return prediction, label_full
