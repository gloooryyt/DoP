...
from .dop_arch import DoPForecast
from .dop_runner import ForecastRunner

from .dop_data import ForecastingDataset
...
# ================= general ================= #
CFG.DESCRIPTION = "DoPForecast(PEMS07) configuration"
...
# ================= model ================= #
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = "DoPForecast"
CFG.MODEL.ARCH = DoPForecast
adj_mx_ori, _ = load_adj("datasets/" + CFG.DATASET_NAME + "/adj_mx.pkl", "original")
